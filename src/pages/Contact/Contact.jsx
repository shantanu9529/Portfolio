        ...
        <div className={styles.box}>
          <div className={styles.right_section_indexing}>
            ...
            <div className={styles.symbol}>
              ...
              <p>Shri Guru Gobind Singhji Institute of Technology, Nanded</p>
            </div>
            ...
            <div className={styles.follow_me_section}>
              ...
              <div className={styles.account_box}>
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://www.linkedin.com/in/shantanu-t/ "
                    target="_blank"
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://github.com/shantanu9529"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <div className={styles.account_icon}>
                  <a
                    href="https://www.instagram.com/shantanu9529/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
